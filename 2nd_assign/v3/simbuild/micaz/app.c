...
typedef TMilli SimpleFloodingC$Forward$precision_tag;
typedef TMilli SimpleFloodingC$Broadcast$precision_tag;
...
static void SimpleFloodingC$AMControl$startDone(error_t error);
#line 138
static void SimpleFloodingC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SimpleFloodingC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void SimpleFloodingC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SimpleFloodingC$init$runTask(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
SimpleFloodingC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
static void SimpleFloodingC$Forward$fired(void );
#line 83
static void SimpleFloodingC$Broadcast$fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SimpleFloodingC$AMControl$start(void );
...
SimpleFloodingC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t SimpleFloodingC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SimpleFloodingC$init$postTask(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleFloodingC$Forward$startOneShot(uint32_t dt);
#line 64
...
uint8_t SimpleFloodingC$index[1000];
uint8_t SimpleFloodingC$fwdIndex[1000];
uint8_t SimpleFloodingC$broadcasts[1000];
bool SimpleFloodingC$broadcastBusy[1000];
bool SimpleFloodingC$forwardBusy[1000];
message_t SimpleFloodingC$broadcastPacket[1000];
message_t SimpleFloodingC$forwardPacket[1000];
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleFloodingC$Forward$startOneShot(uint32_t dt){
#line 73
...
#line 143
      ...
      if (__nesc_ntoh_uint16(recvMsg->sourceID.nxdata) == SimpleFloodingC$nodeID[sim_node()]) 
        {
          sim_log_debug(151U, "Debug", "Discard\n");
          return msg;
        }

      for (i = 0; i < 5; i++) 
        {
          if (__nesc_ntoh_uint16(SimpleFloodingC$cache[sim_node()][i].sourceID.nxdata) == __nesc_ntoh_uint16(recvMsg->sourceID.nxdata) && __nesc_ntoh_uint16(SimpleFloodingC$cache[sim_node()][i].seqNo.nxdata) >= __nesc_ntoh_uint16(recvMsg->seqNo.nxdata)) 
            {
              sim_log_debug(152U, "Debug", "Discard\n");
              return msg;
            }
        }


      SimpleFloodingC$cache[sim_node()][SimpleFloodingC$index[sim_node()]] = *recvMsg;
      sim_log_debug(153U, "Debug", "Cache[%d]: %d:%d\n", SimpleFloodingC$index[sim_node()], __nesc_ntoh_uint16(SimpleFloodingC$cache[sim_node()][SimpleFloodingC$index[sim_node()]].sourceID.nxdata), __nesc_ntoh_uint16(SimpleFloodingC$cache[sim_node()][SimpleFloodingC$index[sim_node()]].seqNo.nxdata));

      SimpleFloodingC$index[sim_node()] = (SimpleFloodingC$index[sim_node()] + 1) % 5;

      sim_log_debug(154U, "SimpleFloodingC", "Received Message with sourceID: %d and seqNo: %d\n", __nesc_ntoh_uint16(recvMsg->sourceID.nxdata), __nesc_ntoh_uint16(recvMsg->seqNo.nxdata));

      SimpleFloodingC$Forward$startOneShot(SimpleFloodingC$nodeID[sim_node()] * 5);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408d4ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408d4ac8) {
#line 78
    case 20:
#line 78
      __nesc_result = SimpleFloodingC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408d4ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SimpleFloodingC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleFloodingC$Broadcast$startPeriodic(uint32_t dt){
#line 64
  ...
  if (error == SUCCESS) 
    {
      ...
      if (SimpleFloodingC$nodeID[sim_node()] % 2 == 1) 
        {
          SimpleFloodingC$Broadcast$startPeriodic((5 + 1) * 100 * SimpleFloodingC$nodeID[sim_node()]);
        }
    }
  else 
...
#line 113
  SimpleFloodingC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SimpleFloodingC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408d4108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x408d4108, msg, error);
#line 110
}
#line 110
...
static inline void SimpleFloodingC$init$runTask(void )
{
  ...
  for (i = 0; i < 5; i++) 
    {
      __nesc_hton_uint16(SimpleFloodingC$cache[sim_node()][i].sourceID.nxdata, 0);
      __nesc_hton_uint16(SimpleFloodingC$cache[sim_node()][i].seqNo.nxdata, 0);
    }

  sim_log_debug(148U, "Debug", "Cache init\n");
}
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SimpleFloodingC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
#line 100
    case 0U:
#line 100
      /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
...
#line 75
      break;
#line 75
    case SimpleFloodingC$init:
#line 75
      SimpleFloodingC$init$runTask();
#line 75
      break;
#line 75
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SimpleFloodingC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * SimpleFloodingC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
static inline void SimpleFloodingC$Forward$fired(void )
{
  if (SimpleFloodingC$forwardBusy[sim_node()] == TRUE) 
    ...
    {
      bcast_msg_t *broadcastMsg = (bcast_msg_t *)SimpleFloodingC$Packet$getPayload(&SimpleFloodingC$forwardPacket[sim_node()], sizeof(bcast_msg_t ));
      ...
      *broadcastMsg = SimpleFloodingC$cache[sim_node()][SimpleFloodingC$fwdIndex[sim_node()]];

      if (SimpleFloodingC$AMSend$send(AM_BROADCAST_ADDR, &SimpleFloodingC$forwardPacket[sim_node()], sizeof(bcast_msg_t )) == SUCCESS) 
        {
          sim_log_debug(157U, "Debug", "Send %s\n", sim_time_string());
          sim_log_debug(158U, "Send", "send %d %d, time: %s\n", __nesc_ntoh_uint16(broadcastMsg->sourceID.nxdata), __nesc_ntoh_uint16(broadcastMsg->seqNo.nxdata), sim_time_string());
          SimpleFloodingC$forwardBusy[sim_node()] = TRUE;
          SimpleFloodingC$fwdIndex[sim_node()] = (SimpleFloodingC$fwdIndex[sim_node()] + 1) % 5;
        }
    }
}
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleFloodingC$Broadcast$stop(void ){
#line 78
...
static inline void SimpleFloodingC$Broadcast$fired(void )
{
  if (SimpleFloodingC$broadcastBusy[sim_node()] == TRUE) 
    ...
    {
      bcast_msg_t *broadcastMsg = (bcast_msg_t *)SimpleFloodingC$Packet$getPayload(&SimpleFloodingC$broadcastPacket[sim_node()], sizeof(bcast_msg_t ));
      ...
      __nesc_hton_uint16(broadcastMsg->sourceID.nxdata, SimpleFloodingC$nodeID[sim_node()]);
      __nesc_hton_uint16(broadcastMsg->seqNo.nxdata, SimpleFloodingC$seqNo[sim_node()]);

      SimpleFloodingC$seqNo[sim_node()]++;
      SimpleFloodingC$broadcasts[sim_node()]++;

      sim_log_debug(159U, "Debug", "Broadcast started @ %s\n", sim_time_string());
      sim_log_debug(160U, "SimpleFloodingC", "Broadcasted message with nodeID: %d and seqNo: %d\n", __nesc_ntoh_uint16(broadcastMsg->sourceID.nxdata), __nesc_ntoh_uint16(broadcastMsg->seqNo.nxdata));

      if (SimpleFloodingC$AMSend$send(AM_BROADCAST_ADDR, &SimpleFloodingC$broadcastPacket[sim_node()], sizeof(bcast_msg_t )) == SUCCESS) 
        {
          sim_log_debug(161U, "Debug", "Sent %s\n", sim_time_string());
          sim_log_debug(162U, "Send", "send %d %d, time: %s\n", __nesc_ntoh_uint16(broadcastMsg->sourceID.nxdata), __nesc_ntoh_uint16(broadcastMsg->seqNo.nxdata), sim_time_string());

          SimpleFloodingC$broadcastBusy[sim_node()] = TRUE;
        }

      if (SimpleFloodingC$broadcasts[sim_node()] == 5) 
        {
          SimpleFloodingC$Broadcast$stop();
          sim_log_debug(163U, "Debug", "Broadcast stopped\n");
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b96c70){
#line 83
  switch (arg_0x40b96c70) {
#line 83
    case 0U:
#line 83
      SimpleFloodingC$Forward$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SimpleFloodingC$Broadcast$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b96c70);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 62
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SimpleFloodingC$init$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SimpleFloodingC$init);
#line 67
...
static void SimpleFloodingC$AMSend$sendDone(message_t *msg, error_t error)
{
  if (&SimpleFloodingC$broadcastPacket[sim_node()] == msg) 
    {
      sim_log_debug(155U, "Debug", "Bcast Sent done %s\n", sim_time_string());
    ...
    if (&SimpleFloodingC$forwardPacket[sim_node()] == msg) 
      {
        ...
        SimpleFloodingC$forwardBusy[sim_node()] = FALSE;
      }
    }
}
...
#line 55
{
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 20);
  return /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SimpleFloodingC$cache"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$cache[__nesc_mote];
    *size = sizeof(SimpleFloodingC$cache[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$nodeID"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$nodeID[__nesc_mote];
    *size = sizeof(SimpleFloodingC$nodeID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$seqNo"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$seqNo[__nesc_mote];
    *size = sizeof(SimpleFloodingC$seqNo[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$index"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$index[__nesc_mote];
    *size = sizeof(SimpleFloodingC$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$fwdIndex"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$fwdIndex[__nesc_mote];
    *size = sizeof(SimpleFloodingC$fwdIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$broadcasts"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$broadcasts[__nesc_mote];
    *size = sizeof(SimpleFloodingC$broadcasts[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$broadcastBusy"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$broadcastBusy[__nesc_mote];
    *size = sizeof(SimpleFloodingC$broadcastBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$forwardBusy"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$forwardBusy[__nesc_mote];
    *size = sizeof(SimpleFloodingC$forwardBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$broadcastPacket"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$broadcastPacket[__nesc_mote];
    *size = sizeof(SimpleFloodingC$broadcastPacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleFloodingC$forwardPacket"))
  {
    *addr = (uintptr_t)&SimpleFloodingC$forwardPacket[__nesc_mote];
    *size = sizeof(SimpleFloodingC$forwardPacket[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SimpleFloodingC */
  memset((void *)&SimpleFloodingC$cache[__nesc_mote], 0, sizeof SimpleFloodingC$cache[__nesc_mote]);
  memset((void *)&SimpleFloodingC$nodeID[__nesc_mote], 0, sizeof SimpleFloodingC$nodeID[__nesc_mote]);
  SimpleFloodingC$seqNo[__nesc_mote] = 1;
  SimpleFloodingC$index[__nesc_mote] = 0;
  SimpleFloodingC$fwdIndex[__nesc_mote] = 0;
  SimpleFloodingC$broadcasts[__nesc_mote] = 0;
  SimpleFloodingC$broadcastBusy[__nesc_mote] = FALSE;
  SimpleFloodingC$forwardBusy[__nesc_mote] = FALSE;
  memset((void *)&SimpleFloodingC$broadcastPacket[__nesc_mote], 0, sizeof SimpleFloodingC$broadcastPacket[__nesc_mote]);
  memset((void *)&SimpleFloodingC$forwardPacket[__nesc_mote], 0, sizeof SimpleFloodingC$forwardPacket[__nesc_mote]);
