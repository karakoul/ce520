...
typedef nx_struct bcast_msg {
  ...
  nx_uint16_t seqNo;
} __attribute__((packed)) bcast_msg_t;
...
typedef button_state_t SimpleFloodingC__Notify__val_t;
typedef TMilli SimpleFloodingC__Forward__precision_tag;
typedef button_state_t SimpleFloodingC__Get__val_t;
...
static void SimpleFloodingC__AMControl__startDone(error_t error);
#line 138
static void SimpleFloodingC__AMControl__stopDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SimpleFloodingC__Boot__booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void SimpleFloodingC__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SimpleFloodingC__init__runTask(void );
...
SimpleFloodingC__Receive__receive(
#line 71
message_t * msg, 
void * payload, 
...
static void SimpleFloodingC__Notify__notify(SimpleFloodingC__Notify__val_t val);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleFloodingC__Forward__fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SimpleFloodingC__AMControl__start(void );
...
SimpleFloodingC__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t SimpleFloodingC__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SimpleFloodingC__init__postTask(void );
# 59 "/opt/tinyos-2.1.2/tos/interfaces/Notify.nc"
static error_t SimpleFloodingC__Notify__enable(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void SimpleFloodingC__Leds__led0Toggle(void );
#line 83
static void SimpleFloodingC__Leds__led1Toggle(void );
#line 100
static void SimpleFloodingC__Leds__led2Toggle(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleFloodingC__Forward__startOneShot(uint32_t dt);
# 87 "SimpleFloodingC.nc"
enum SimpleFloodingC____nesc_unnamed4310 {
#line 87
  SimpleFloodingC__init = 0U
};
#line 87
typedef int SimpleFloodingC____nesc_sillytask_init[SimpleFloodingC__init];
#line 75
bcast_msg_t SimpleFloodingC__cache[5];
uint16_t SimpleFloodingC__nodeID;
uint16_t SimpleFloodingC__seqNo = 1;
uint8_t SimpleFloodingC__index = 0;
uint8_t SimpleFloodingC__fwdIndex = 0;

bool SimpleFloodingC__broadcastBusy = FALSE;
bool SimpleFloodingC__forwardBusy = FALSE;
message_t SimpleFloodingC__broadcastPacket;
message_t SimpleFloodingC__forwardPacket;


static inline void SimpleFloodingC__init__runTask(void );
#line 100
static inline void SimpleFloodingC__Boot__booted(void );
#line 112
static inline void SimpleFloodingC__AMControl__startDone(error_t error);
#line 133
static inline message_t *SimpleFloodingC__Receive__receive(message_t *msg, void *payload, uint8_t len);
#line 185
static inline void SimpleFloodingC__AMControl__stopDone(error_t error);

static void SimpleFloodingC__AMSend__sendDone(message_t *msg, error_t error);
#line 204
static inline void SimpleFloodingC__Forward__fired(void );
#line 282
static void SimpleFloodingC__Notify__notify(button_state_t state);
# 42 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x4067ab28){
#line 39
  switch (arg_0x4067ab28) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x4067ab28);
#line 39
      break;
#line 39
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40dbc430){
#line 65
  switch (arg_0x40dbc430) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40dbc430);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40cbaf08){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x40cbaf08) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40cbaf08);
#line 120
      break;
#line 120
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x410b9148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x410b9148, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40cbaf08){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40cbaf08);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40cb8970){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40cb8970);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40dbc430){
#line 59
  switch (arg_0x40dbc430) {
#line 59
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40dbc430);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40dbd010){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40dbd010);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40cbaf08){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40cbaf08);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40dbd010){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x40dbd010);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40cbaf08){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40cbaf08);
#line 88
      break;
#line 88
    }
...
#line 74
  SimpleFloodingC__Notify__notify(val);
#line 74
}
#line 74
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x409e5730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x409e5730, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x410baa98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x410baa98, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x410b9148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x410b9148, msg);
#line 95
}
#line 95
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4105d628){
#line 102
  switch (arg_0x4105d628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4105d628);
#line 102
      break;
#line 102
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x410bc088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x410bc088, msg, payload, len);
#line 78
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleFloodingC__Forward__startOneShot(uint32_t dt){
#line 73
...
inline static void SimpleFloodingC__Leds__led2Toggle(void ){
#line 100
...
inline static void SimpleFloodingC__Leds__led1Toggle(void ){
#line 83
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void SimpleFloodingC__Leds__led0Toggle(void ){
#line 67
...
#line 143
      ...
      if (__nesc_ntoh_uint16(recvMsg->sourceID.nxdata) == SimpleFloodingC__nodeID) 
        {
          ;
          return msg;
        }
      ...
      for (i = 0; i < 5; i++) 
        {
          if (__nesc_ntoh_uint16(SimpleFloodingC__cache[i].sourceID.nxdata) == __nesc_ntoh_uint16(recvMsg->sourceID.nxdata) && __nesc_ntoh_uint16(SimpleFloodingC__cache[i].seqNo.nxdata) >= __nesc_ntoh_uint16(recvMsg->seqNo.nxdata)) 
            {
              ;
              return msg;
            }
      ...
      SimpleFloodingC__cache[SimpleFloodingC__index] = *recvMsg;
      ;
      if (__nesc_ntoh_uint16(recvMsg->sourceID.nxdata) == 1) {
          SimpleFloodingC__Leds__led0Toggle();
        }
      else {
#line 168
        if (__nesc_ntoh_uint16(recvMsg->sourceID.nxdata) == 2) {
            SimpleFloodingC__Leds__led1Toggle();
          }
        else {
            SimpleFloodingC__Leds__led2Toggle();
          }
        }
      SimpleFloodingC__index = (SimpleFloodingC__index + 1) % 5;

      ;

      SimpleFloodingC__Forward__startOneShot(SimpleFloodingC__nodeID * 5);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x410bd9d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x410bd9d0) {
#line 78
    case 20:
#line 78
      __nesc_result = SimpleFloodingC__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x410bd9d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40cbeb70){
#line 102
  switch (arg_0x40cbeb70) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40cbeb70);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40dbe520){
#line 102
  switch (arg_0x40dbe520) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40dbe520);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40cba710, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x40cba710) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40cba710, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40c26828, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40c26828) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40c26828, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x410b9148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x410b9148, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40c26828, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40c26828) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40c26828, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40c29db0){
#line 102
  switch (arg_0x40c29db0) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x40c29db0);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x410bd010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x410bd010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  SimpleFloodingC__AMControl__stopDone(error);
#line 138
}
#line 138
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SimpleFloodingC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
static inline void SimpleFloodingC__AMControl__startDone(error_t error)
{
  if (error == SUCCESS) 
    {
      SimpleFloodingC__nodeID = TOS_NODE_ID;
    }
  else 
    ...
    {
      SimpleFloodingC__AMControl__start();
    }
}
...
#line 113
  SimpleFloodingC__AMControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 51
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  SimpleFloodingC__AMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x409e8c90, message_t * msg, error_t error){
#line 100
  switch (arg_0x409e8c90) {
#line 100
    case 0U:
#line 100
      /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x409e8c90, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SimpleFloodingC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * SimpleFloodingC__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 204 "SimpleFloodingC.nc"
static inline void SimpleFloodingC__Forward__fired(void )
{
  if (SimpleFloodingC__forwardBusy == TRUE) 
    {
      SimpleFloodingC__Forward__startOneShot(SimpleFloodingC__nodeID * 5);
      return;
    }
    ...
    {
      bcast_msg_t *broadcastMsg = (bcast_msg_t *)SimpleFloodingC__Packet__getPayload(&SimpleFloodingC__forwardPacket, sizeof(bcast_msg_t ));

      if (broadcastMsg == (void *)0) 
        {
          return;
        }

      *broadcastMsg = SimpleFloodingC__cache[SimpleFloodingC__fwdIndex];

      if (SimpleFloodingC__AMSend__send(AM_BROADCAST_ADDR, &SimpleFloodingC__forwardPacket, sizeof(bcast_msg_t )) == SUCCESS) 
        {
          ;
          ;
          SimpleFloodingC__forwardBusy = TRUE;
          SimpleFloodingC__fwdIndex = (SimpleFloodingC__fwdIndex + 1) % 5;
        }
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x4098a9f0){
#line 83
  switch (arg_0x4098a9f0) {
#line 83
    case 0U:
#line 83
      SimpleFloodingC__Forward__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x4098a9f0);
#line 83
      break;
#line 83
    }
...
static inline void SimpleFloodingC__init__runTask(void )
{
  ...
  for (i = 0; i < 5; i++) 
    {
      __nesc_hton_uint16(SimpleFloodingC__cache[i].sourceID.nxdata, 0);
      __nesc_hton_uint16(SimpleFloodingC__cache[i].seqNo.nxdata, 0);
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/Notify.nc"
inline static error_t SimpleFloodingC__Notify__enable(void ){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 59
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SimpleFloodingC__init__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SchedulerBasicP__TaskBasic__postTask(SimpleFloodingC__init);
#line 67
...
static inline void SimpleFloodingC__Boot__booted(void )
{
  ...
  SimpleFloodingC__init__postTask();


  SimpleFloodingC__Notify__enable();
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40d840c0, uint8_t data){
#line 54
  switch (arg_0x40d840c0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40d840c0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x40d84940){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x40d84940);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40d840c0){
#line 49
  switch (arg_0x40d840c0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40d840c0);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x4067ab28){
#line 39
  switch (arg_0x4067ab28) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x4067ab28);
#line 39
      break;
#line 39
    }
...
#line 75
    case SimpleFloodingC__init:
#line 75
      SimpleFloodingC__init__runTask();
#line 75
      break;
#line 75
...
#line 75
# 282 "SimpleFloodingC.nc"
static void SimpleFloodingC__Notify__notify(button_state_t state)
{
  bcast_msg_t *broadcastMsg = (bcast_msg_t *)SimpleFloodingC__Packet__getPayload(&SimpleFloodingC__broadcastPacket, sizeof(bcast_msg_t ));

  __nesc_hton_uint16(broadcastMsg->sourceID.nxdata, SimpleFloodingC__nodeID);
  __nesc_hton_uint16(broadcastMsg->seqNo.nxdata, SimpleFloodingC__seqNo);

  SimpleFloodingC__seqNo++;
  if (SimpleFloodingC__AMSend__send(AM_BROADCAST_ADDR, &SimpleFloodingC__broadcastPacket, sizeof(bcast_msg_t )) == SUCCESS) 
    {
      SimpleFloodingC__broadcastBusy = TRUE;
    }
}
...
#line 55
{
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 20);
  return /*SimpleFloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
...
# 187 "SimpleFloodingC.nc"
static void SimpleFloodingC__AMSend__sendDone(message_t *msg, error_t error)
{
  if (&SimpleFloodingC__broadcastPacket == msg) 
    {
      ;

      SimpleFloodingC__broadcastBusy = FALSE;
    }
  else {
#line 195
    if (&SimpleFloodingC__forwardPacket == msg) 
      {
        ;

        SimpleFloodingC__forwardBusy = FALSE;
      }
    }
}
