...
static inline void BcastC$Control$startDone(error_t error)
{
  if (error != SUCCESS) 
  ...
  else 
    {
      ...
      BcastC$Timer$startPeriodic(TIMER_PERIOD_MILLI);
    }
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40bcb6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40bcb6a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40bcb6a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40bca0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40bca0a0, addr, msg, len);
#line 80
...
static inline void BcastC$Timer$fired(void )
{
  if (!BcastC$busy[sim_node()] && BcastC$node_id[sim_node()] == 1) 
    {
      msg_t *bcast_msg;
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b5c3a8){
#line 83
  switch (arg_0x40b5c3a8) {
#line 83
    case 0U:
#line 83
      BcastC$Timer$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b5c3a8);
#line 83
      break;
#line 83
    }
