...
#line 75
static void BcastC$search$runTask(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void BcastC$forward$runTask(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4302 {
...
#line 67
static error_t BcastC$search$postTask(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t BcastC$Control$start(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t BcastC$forward$postTask(void );
# 27 "BcastC.nc"
enum BcastC$__nesc_unnamed4306 {
#line 27
  BcastC$forward = 3U
};
#line 27
typedef int BcastC$__nesc_sillytask_forward[BcastC$forward];
#line 52
enum BcastC$__nesc_unnamed4307 {
#line 52
  BcastC$search = 4U
};
#line 52
typedef int BcastC$__nesc_sillytask_search[BcastC$search];
#line 68
enum BcastC$__nesc_unnamed4308 {
#line 68
  BcastC$init = 5U
};
#line 68
...
static inline void BcastC$forward$runTask(void );
#line 52
static inline void BcastC$search$runTask(void );
#line 68
...
#line 57
#line 55
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4311 {
  message_t * msg;
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t BcastC$search$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(BcastC$search);
#line 67
  ...
  if (len == sizeof(msg_t )) 
    {
      ...
      sim_log_debug(160U, "Receive", "receive %d %d\n", __nesc_ntoh_uint16(BcastC$rec_msg[sim_node()]->nodeid.nxdata), __nesc_ntoh_uint16(BcastC$rec_msg[sim_node()]->seq_num.nxdata));

      BcastC$search$postTask();
    }
  return msg;
}
...
static inline void BcastC$Control$startDone(error_t error)
{
  if (error != SUCCESS) 
  ...
  else 
    {
      ...
      if (!BcastC$busy[sim_node()] && ((BcastC$node_id[sim_node()] == 1 || BcastC$node_id[sim_node()] == 4) || BcastC$node_id[sim_node()] == 10)) 
        {
          msg_t *bcast_msg;
...
#line 30
  ...
  if (BcastC$AMSend$send(AM_BROADCAST_ADDR, &BcastC$packet[sim_node()], sizeof BcastC$rec_msg[sim_node()]) == SUCCESS) 
    {
      BcastC$busy[sim_node()] = TRUE;
    }

  sim_log_debug(158U, "Send", "send %d %d\n", __nesc_ntoh_uint16(BcastC$rec_msg[sim_node()]->nodeid.nxdata), __nesc_ntoh_uint16(BcastC$rec_msg[sim_node()]->seq_num.nxdata));
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t BcastC$forward$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(BcastC$forward);
#line 67
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40a3b8a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40a3b8a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40a3b8a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 75
    case BcastC$forward:
#line 75
      BcastC$forward$runTask();
#line 75
      break;
#line 75
    case BcastC$search:
#line 75
      BcastC$search$runTask();
#line 75
      break;
#line 75
    case BcastC$init:
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40a3a2b0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40a3a2b0, addr, msg, len);
#line 80
