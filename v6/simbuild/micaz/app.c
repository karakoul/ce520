...
typedef uint16_t BrightnessSensorC$Read$val_t;
typedef TMilli BrightnessSensorC$Timer$precision_tag;
...
typedef uint16_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t;
typedef /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t;
...
static void BrightnessSensorC$Boot$booted(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void BrightnessSensorC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void BrightnessSensorC$Read$readDone(error_t result, BrightnessSensorC$Read$val_t val);
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void BrightnessSensorC$Control$startDone(error_t error);
#line 138
static void BrightnessSensorC$Control$stopDone(error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void BrightnessSensorC$CheckBrightness$runTask(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void BrightnessSensorC$Timer$fired(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
static error_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );
...
am_id_t t);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t BrightnessSensorC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static error_t BrightnessSensorC$Read$read(void );
...
BrightnessSensorC$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 94 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
static void BrightnessSensorC$Leds$led2Off(void );
#line 89
static void BrightnessSensorC$Leds$led2On(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t BrightnessSensorC$Control$start(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t BrightnessSensorC$CheckBrightness$postTask(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void BrightnessSensorC$Timer$startPeriodic(uint32_t dt);
# 24 "BrightnessSensorC.nc"
enum BrightnessSensorC$__nesc_unnamed4333 {
#line 24
  BrightnessSensorC$CheckBrightness = 3U
};
#line 24
typedef int BrightnessSensorC$__nesc_sillytask_CheckBrightness[BrightnessSensorC$CheckBrightness];
#line 19
uint16_t BrightnessSensorC$brightness[1000];
bool BrightnessSensorC$ledIsOn[1000];
message_t BrightnessSensorC$packet[1000];
bool BrightnessSensorC$busy[1000];

static inline void BrightnessSensorC$CheckBrightness$runTask(void );
#line 40
static inline void BrightnessSensorC$Boot$booted(void );
...
static inline void BrightnessSensorC$Control$startDone(error_t error);
...
static inline void BrightnessSensorC$Control$stopDone(error_t error);




static inline void BrightnessSensorC$Timer$fired(void );





static inline void BrightnessSensorC$Read$readDone(error_t result, uint16_t data);
#line 95
static inline void BrightnessSensorC$AMSend$sendDone(message_t *msg, error_t error);
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void );
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
enum /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_unnamed4339 {
#line 47
  ConstantSensorC$0$senseResult = 6U
};
#line 47
typedef int /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_sillytask_senseResult[/*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult];
#line 47
static inline void /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );



static inline error_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
static error_t /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(
# 48 "/opt/tinyos-2.1.2/tos/system/AMQueueImplP.nc"
am_id_t arg_0x40c090a0, 
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
am_addr_t addr, 
#line 71
message_t * msg, 
...
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x408d0108, msg, error);
#line 110
}
#line 110
...
# 94 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void BrightnessSensorC$Leds$led2Off(void ){
#line 94
  LedsP$Leds$led2Off();
#line 94
}
...
inline static void BrightnessSensorC$Leds$led2On(void ){
#line 89
  LedsP$Leds$led2On();
#line 89
}
...
#line 24
{
  ...
  if (BrightnessSensorC$brightness[sim_node()] < 40) {
      if (!BrightnessSensorC$ledIsOn[sim_node()]) {
          BrightnessSensorC$Leds$led2On();
          BrightnessSensorC$ledIsOn[sim_node()] = TRUE;
        }
    }
  else {
      if (BrightnessSensorC$ledIsOn[sim_node()]) {
          BrightnessSensorC$Leds$led2Off();
          BrightnessSensorC$ledIsOn[sim_node()] = FALSE;
        }
    }
}
...
#line 82
{
  sim_log_debug(187U, "Serial", "Serial: sending a packet of size %d\n", len);
  return FAIL;
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40c090a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = SerialActiveMessageC$AMSend$send(arg_0x40c090a0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 3);
  return /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t BrightnessSensorC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * BrightnessSensorC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t BrightnessSensorC$CheckBrightness$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(BrightnessSensorC$CheckBrightness);
#line 67
...
#line 67
# 67 "BrightnessSensorC.nc"
static inline void BrightnessSensorC$Read$readDone(error_t result, uint16_t data)
#line 67
{
  sim_log_debug(149U, "Brightness", "Check %d \n", data);
  if (result == SUCCESS) {
      BrightnessSensorC$brightness[sim_node()] = data;
      BrightnessSensorC$CheckBrightness$postTask();
      if (!BrightnessSensorC$busy[sim_node()]) {
          Bright_Msg *send_message;

#line 74
          send_message = (Bright_Msg *)BrightnessSensorC$Packet$getPayload(&BrightnessSensorC$packet[sim_node()], sizeof(Bright_Msg ));

          if (send_message == (void *)0) {
              return;
            }

          __nesc_hton_uint16(send_message->brightness.nxdata, BrightnessSensorC$brightness[sim_node()]);
          __nesc_hton_uint16(send_message->nodeId.nxdata, TOS_NODE_ID);

          if (BrightnessSensorC$AMSend$send(AM_BROADCAST_ADDR, &BrightnessSensorC$packet[sim_node()], sizeof(Bright_Msg )) == SUCCESS) {
              BrightnessSensorC$busy[sim_node()] = TRUE;
            }
        }
    }
  else {
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val){
#line 63
  BrightnessSensorC$Read$readDone(result, val);
#line 63
}
#line 63
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
...
#line 47
{
  /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(SUCCESS, 48879U);
}
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void BrightnessSensorC$Timer$startPeriodic(uint32_t dt){
#line 64
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t BrightnessSensorC$Control$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 47 "BrightnessSensorC.nc"
static inline void BrightnessSensorC$Control$startDone(error_t error)
#line 47
{
  if (error != SUCCESS) {
      BrightnessSensorC$Control$start();
    }
  else {
      BrightnessSensorC$Timer$startPeriodic(1000);
    }
}
...
#line 113
  BrightnessSensorC$Control$startDone(error);
#line 113
}
#line 113
# 67 "/opt/tinyos-2.1.2/tos/lib/tossim/SerialActiveMessageC.nc"
...
#line 138
  BrightnessSensorC$Control$stopDone(error);
#line 138
}
#line 138
...
# 95 "BrightnessSensorC.nc"
static inline void BrightnessSensorC$AMSend$sendDone(message_t *msg, error_t error)
#line 95
{
  if (&BrightnessSensorC$packet[sim_node()] == msg) {
      BrightnessSensorC$busy[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  BrightnessSensorC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40c0a6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40c0a6a8) {
#line 100
    case 0U:
#line 100
      /*BrightnessSensorAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40c0a6a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 75
      break;
#line 75
    case BrightnessSensorC$CheckBrightness:
#line 75
      BrightnessSensorC$CheckBrightness$runTask();
#line 75
      break;
#line 75
...
#line 75
      break;
#line 75
    case /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult:
#line 75
      /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask();
#line 75
      break;
#line 75
...
#line 53
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult);
#line 67
...
#line 51
{
  return /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask();
}

# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static error_t BrightnessSensorC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*BrightnessSensorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read();
#line 55
...
#line 55
# 61 "BrightnessSensorC.nc"
static inline void BrightnessSensorC$Timer$fired(void )
#line 61
{
  sim_log_debug(148U, "BrightnessSensor", "Check %s \n", sim_time_string());
  BrightnessSensorC$Read$read();
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b5b3a8){
#line 83
  switch (arg_0x40b5b3a8) {
#line 83
    case 0U:
#line 83
      BrightnessSensorC$Timer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b5b3a8);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "BrightnessSensorC$brightness"))
  {
    *addr = (uintptr_t)&BrightnessSensorC$brightness[__nesc_mote];
    *size = sizeof(BrightnessSensorC$brightness[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BrightnessSensorC$ledIsOn"))
  {
    *addr = (uintptr_t)&BrightnessSensorC$ledIsOn[__nesc_mote];
    *size = sizeof(BrightnessSensorC$ledIsOn[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BrightnessSensorC$packet"))
  {
    *addr = (uintptr_t)&BrightnessSensorC$packet[__nesc_mote];
    *size = sizeof(BrightnessSensorC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "BrightnessSensorC$busy"))
  {
    *addr = (uintptr_t)&BrightnessSensorC$busy[__nesc_mote];
    *size = sizeof(BrightnessSensorC$busy[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module BrightnessSensorC */
  memset((void *)&BrightnessSensorC$brightness[__nesc_mote], 0, sizeof BrightnessSensorC$brightness[__nesc_mote]);
  BrightnessSensorC$ledIsOn[__nesc_mote] = FALSE;
  memset((void *)&BrightnessSensorC$packet[__nesc_mote], 0, sizeof BrightnessSensorC$packet[__nesc_mote]);
  BrightnessSensorC$busy[__nesc_mote] = FALSE;
