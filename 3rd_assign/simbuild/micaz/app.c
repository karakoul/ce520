...
#line 75
static inline void QueryPropagationC$AMSend$sendDone(message_t *msg, error_t error);
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void QueryPropagationC$QueryTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(0U, dt);
#line 73
}
#line 73
# 31 "QueryPropagationC.nc"
static inline void QueryPropagationC$AMControl$startDone(error_t error)
{
  if (error == SUCCESS) 
    {
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40b896a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40b896a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40b896a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40b880a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40b880a0, addr, msg, len);
#line 80
