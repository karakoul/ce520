...
typedef nx_struct __nesc_unnamed4281 {
  ...
  nx_uint8_t aggregationMode;
  nx_uint16_t currentPeriod;
  nx_uint16_t address;
...
typedef TMilli QueryPropagationC$SensorTimer$precision_tag;
typedef uint16_t QueryPropagationC$Read$val_t;
typedef TMilli QueryPropagationC$ForwardQueryTimer$precision_tag;
typedef TMilli QueryPropagationC$QueryTimer$precision_tag;
...
typedef uint16_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t;
typedef /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t;
...
static void QueryPropagationC$SensorTimer$fired(void );
...
static void QueryPropagationC$AMControl$startDone(error_t error);
#line 138
static void QueryPropagationC$AMControl$stopDone(error_t error);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void QueryPropagationC$AMSend$sendDone(
#line 103
message_t * msg, 
...
QueryPropagationC$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void QueryPropagationC$ForwardQueryTimer$fired(void );
#line 83
static void QueryPropagationC$QueryTimer$fired(void );
...
static error_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void QueryPropagationC$SensorTimer$startPeriodic(uint32_t dt);
#line 78
static void QueryPropagationC$SensorTimer$stop(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t QueryPropagationC$AMControl$start(void );
...
uint8_t len);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t QueryPropagationC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void QueryPropagationC$ForwardQueryTimer$startOneShot(uint32_t dt);
#line 73
static void QueryPropagationC$QueryTimer$startOneShot(uint32_t dt);
# 68 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t QueryPropagationC$AMPacket$address(void );
# 22 "QueryPropagationC.nc"
message_t QueryPropagationC$queryPacket[1000];
message_t QueryPropagationC$fwdQueryPacket[1000];
message_t QueryPropagationC$nonePacket[1000];
uint16_t QueryPropagationC$seqNo[1000];
bool QueryPropagationC$broadcastBusy[1000];
bool QueryPropagationC$forwardBusy[1000];
uint16_t QueryPropagationC$nodeID[1000];
query_t QueryPropagationC$cache[1000][5];
uint16_t QueryPropagationC$index[1000];
uint16_t QueryPropagationC$fwdIndex[1000];
bool QueryPropagationC$sensorState[1000][3];

static inline void QueryPropagationC$Boot$booted(void );
#line 52
static inline void QueryPropagationC$AMControl$startDone(error_t error);
#line 70
static inline void QueryPropagationC$AMControl$stopDone(error_t error);


static inline void QueryPropagationC$QueryTimer$fired(void );
#line 107
static inline void QueryPropagationC$ForwardQueryTimer$fired(void );
#line 136
static inline void QueryPropagationC$SensorTimer$fired(void );
#line 151
static inline void QueryPropagationC$Read$readDone(error_t result, uint16_t data);
#line 177
static void QueryPropagationC$AMSend$sendDone(message_t *msg, error_t error);
#line 189
static inline message_t *QueryPropagationC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void );
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
enum /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_unnamed4344 {
#line 47
  ConstantSensorC$0$senseResult = 7U
};
#line 47
typedef int /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_sillytask_senseResult[/*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult];
#line 47
static inline void /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );



static inline error_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void QueryPropagationC$SensorTimer$startPeriodic(uint32_t dt){
#line 64
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void QueryPropagationC$ForwardQueryTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(1U, dt);
#line 73
}
#line 73
# 189 "QueryPropagationC.nc"
static inline message_t *QueryPropagationC$Receive$receive(message_t *msg, void *payload, uint8_t len)
{
  if (len != sizeof(query_t )) 
    {
      sim_log_debug(154U, "Query", "RECEIVED\n");
      return msg;
    }
  else 
    {
...
#line 200
      ...
      sim_log_debug(155U, "Query", "Query Receive Type: %d samplingPeriod: %d  lifeTime: %d, time: %s\n", __nesc_ntoh_uint8(recvQuery->sensorT.nxdata), __nesc_ntoh_uint16(recvQuery->samplingPeriod.nxdata), __nesc_ntoh_uint16(recvQuery->lifeTime.nxdata), sim_time_string());

      if (__nesc_ntoh_uint16(recvQuery->sensorID.nxdata) == QueryPropagationC$nodeID[sim_node()]) 
        {
          return msg;
        }
      ...
      for (i = 0; i < 5; i++) 
        {
          if (__nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][i].sensorID.nxdata) == __nesc_ntoh_uint16(recvQuery->sensorID.nxdata) && __nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][i].seqNo.nxdata) >= __nesc_ntoh_uint16(recvQuery->seqNo.nxdata)) 
            {
              sim_log_debug(156U, "Debug", "Discard\n");
              return msg;
            }
        }


      QueryPropagationC$cache[sim_node()][QueryPropagationC$index[sim_node()]] = *recvQuery;

      QueryPropagationC$index[sim_node()] = (QueryPropagationC$index[sim_node()] + 1) % 5;

      QueryPropagationC$ForwardQueryTimer$startOneShot(QueryPropagationC$nodeID[sim_node()] * 1);

      if (QueryPropagationC$sensorState[sim_node()][__nesc_ntoh_uint8(recvQuery->sensorT.nxdata)] == FALSE) 
        {
          QueryPropagationC$sensorState[sim_node()][__nesc_ntoh_uint8(recvQuery->sensorT.nxdata)] = TRUE;
          QueryPropagationC$SensorTimer$startPeriodic(__nesc_ntoh_uint16(recvQuery->samplingPeriod.nxdata) * 1000);
        }
...
#line 78
    case 20:
#line 78
      __nesc_result = QueryPropagationC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t QueryPropagationC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 52 "QueryPropagationC.nc"
static inline void QueryPropagationC$AMControl$startDone(error_t error)
{
  if (error == SUCCESS) 
    {
      QueryPropagationC$nodeID[sim_node()] = TOS_NODE_ID;


      if (QueryPropagationC$nodeID[sim_node()] == 1) {
          QueryPropagationC$QueryTimer$startOneShot(1000);
        }
    }
  else 

    {
      QueryPropagationC$AMControl$start();
    }
}
...
#line 113
  QueryPropagationC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  QueryPropagationC$AMControl$stopDone(error);
#line 138
}
#line 138
...
#line 110
  QueryPropagationC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40bab010, message_t * msg, error_t error){
#line 100
  switch (arg_0x40bab010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40bab010, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t QueryPropagationC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80
...
#line 126
# 151 "QueryPropagationC.nc"
static inline void QueryPropagationC$Read$readDone(error_t result, uint16_t data)
{

  if (result == SUCCESS) 
    {
      aggregation_none_t *resultMsg = (aggregation_none_t *)QueryPropagationC$Packet$getPayload(&QueryPropagationC$nonePacket[sim_node()], sizeof(aggregation_none_t ));

#line 156
      ;

      __nesc_hton_uint16(resultMsg->sensorID.nxdata, QueryPropagationC$nodeID[sim_node()]);
      __nesc_hton_uint16(resultMsg->sensorValue.nxdata, data);
      __nesc_hton_uint16(resultMsg->iterPeriod.nxdata, 0);

      if (QueryPropagationC$AMSend$send(__nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][0].address.nxdata), &QueryPropagationC$nonePacket[sim_node()], sizeof(aggregation_none_t )) == SUCCESS) 
        {
          sim_log_debug(153U, "Query", "Results Send: Type = %d, Time: %s\n", __nesc_ntoh_uint16(resultMsg->sensorValue.nxdata), sim_time_string());
          QueryPropagationC$broadcastBusy[sim_node()] = TRUE;
        }
    }
  else 
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val){
#line 63
...
#line 47
{
  /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(SUCCESS, 48879U);
}
...
#line 75
      break;
#line 75
    case /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult:
#line 75
      /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask();
#line 75
      break;
#line 75
    default:
...
#line 162
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40bab9f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40bab9f8, addr, msg, len);
#line 80
...
# 68 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t QueryPropagationC$AMPacket$address(void ){
#line 68
  unsigned short __nesc_result;
#line 68
...
#line 68
# 73 "QueryPropagationC.nc"
static inline void QueryPropagationC$QueryTimer$fired(void )
{
  query_t *query = (query_t *)QueryPropagationC$Packet$getPayload(&QueryPropagationC$queryPacket[sim_node()], sizeof(query_t ));

  if (QueryPropagationC$broadcastBusy[sim_node()] == TRUE && QueryPropagationC$forwardBusy[sim_node()] == TRUE) {
      QueryPropagationC$QueryTimer$startOneShot(1);
      return;
    }
  ...
  __nesc_hton_uint16(query->sensorID.nxdata, QueryPropagationC$nodeID[sim_node()]);
  __nesc_hton_uint16(query->seqNo.nxdata, QueryPropagationC$seqNo[sim_node()]);
  __nesc_hton_uint8(query->sensorT.nxdata, BRIGHTNESS);
  __nesc_hton_uint16(query->samplingPeriod.nxdata, 1);
  __nesc_hton_uint16(query->lifeTime.nxdata, 5);
  __nesc_hton_uint16(query->currentPeriod.nxdata, 0);
  __nesc_hton_uint16(query->address.nxdata, QueryPropagationC$AMPacket$address());

  sim_log_debug(148U, "Query", "Sender address %d\n", __nesc_ntoh_uint16(query->address.nxdata));



  if (QueryPropagationC$AMSend$send(AM_BROADCAST_ADDR, &QueryPropagationC$queryPacket[sim_node()], sizeof(query_t )) == SUCCESS) 
    {
      sim_log_debug(149U, "Query", "Query Init: Type = %d, Time: %s\n", __nesc_ntoh_uint8(query->sensorT.nxdata), sim_time_string());
      QueryPropagationC$broadcastBusy[sim_node()] = TRUE;
    }
}
...
static inline void QueryPropagationC$ForwardQueryTimer$fired(void )
{
  if (QueryPropagationC$broadcastBusy[sim_node()] == TRUE && QueryPropagationC$forwardBusy[sim_node()] == TRUE) 
    ...
    {
      query_t *broadcastQuery = (query_t *)QueryPropagationC$Packet$getPayload(&QueryPropagationC$fwdQueryPacket[sim_node()], sizeof(query_t ));

      if (broadcastQuery == (void *)0) 
        {
          return;
        }

      *broadcastQuery = QueryPropagationC$cache[sim_node()][QueryPropagationC$fwdIndex[sim_node()]];

      if (QueryPropagationC$AMSend$send(AM_BROADCAST_ADDR, &QueryPropagationC$fwdQueryPacket[sim_node()], sizeof(query_t )) == SUCCESS) 
        {

          sim_log_debug(150U, "Query", "Query Forward %d %d, time: %s\n", __nesc_ntoh_uint16(broadcastQuery->sensorID.nxdata), __nesc_ntoh_uint16(broadcastQuery->seqNo.nxdata), sim_time_string());
          QueryPropagationC$forwardBusy[sim_node()] = TRUE;
          QueryPropagationC$fwdIndex[sim_node()] = (QueryPropagationC$fwdIndex[sim_node()] + 1) % 5;
        }
    }
}
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void QueryPropagationC$SensorTimer$stop(void ){
#line 78
...
#line 78
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult);
#line 67
...
#line 51
{
  return /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask();
}
...
#line 55
  __nesc_result = /*QueryPropagationAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read();
#line 55
...
#line 139
  ...
  (__nesc_temp42 = QueryPropagationC$cache[sim_node()][0].lifeTime.nxdata, __nesc_hton_uint16(__nesc_temp42, __nesc_ntoh_uint16(__nesc_temp42) - __nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][0].samplingPeriod.nxdata)));
  sim_log_debug(151U, "Lifetime", "New lifetime = %d \n", __nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][0].lifeTime.nxdata));

  if (__nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][0].lifeTime.nxdata) < __nesc_ntoh_uint16(QueryPropagationC$cache[sim_node()][0].samplingPeriod.nxdata)) 
    {
      sim_log_debug(152U, "Lifetime", "Lifetime expired\n");
      QueryPropagationC$SensorTimer$stop();
    }
}
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b6b3a8){
#line 83
  switch (arg_0x40b6b3a8) {
#line 83
    case 0U:
#line 83
      QueryPropagationC$QueryTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      QueryPropagationC$ForwardQueryTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      QueryPropagationC$SensorTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b6b3a8);
#line 83
      break;
#line 83
    }
...
#line 62
# 34 "QueryPropagationC.nc"
static inline void QueryPropagationC$Boot$booted(void )
{
  int i;

  QueryPropagationC$seqNo[sim_node()] = 0;
  QueryPropagationC$index[sim_node()] = 0;
  QueryPropagationC$fwdIndex[sim_node()] = 0;
  QueryPropagationC$broadcastBusy[sim_node()] = FALSE;
  QueryPropagationC$forwardBusy[sim_node()] = FALSE;

  for (i = 0; i < 3; i++) 
    {
      QueryPropagationC$sensorState[sim_node()][i] = FALSE;
    }
...
#line 55
{
  ...
  /*QueryPropagationAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 20);
...
# 177 "QueryPropagationC.nc"
static void QueryPropagationC$AMSend$sendDone(message_t *msg, error_t error)
{
  if (&QueryPropagationC$queryPacket[sim_node()] == msg) 
    {
      QueryPropagationC$broadcastBusy[sim_node()] = FALSE;
    }
  else {
#line 183
    if (&QueryPropagationC$fwdQueryPacket[sim_node()] == msg) 
      {
        QueryPropagationC$forwardBusy[sim_node()] = FALSE;
      }
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "QueryPropagationC$queryPacket"))
  {
    *addr = (uintptr_t)&QueryPropagationC$queryPacket[__nesc_mote];
    *size = sizeof(QueryPropagationC$queryPacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$fwdQueryPacket"))
  {
    *addr = (uintptr_t)&QueryPropagationC$fwdQueryPacket[__nesc_mote];
    *size = sizeof(QueryPropagationC$fwdQueryPacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$nonePacket"))
  {
    *addr = (uintptr_t)&QueryPropagationC$nonePacket[__nesc_mote];
    *size = sizeof(QueryPropagationC$nonePacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$seqNo"))
  {
    *addr = (uintptr_t)&QueryPropagationC$seqNo[__nesc_mote];
    *size = sizeof(QueryPropagationC$seqNo[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$broadcastBusy"))
  {
    *addr = (uintptr_t)&QueryPropagationC$broadcastBusy[__nesc_mote];
    *size = sizeof(QueryPropagationC$broadcastBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$forwardBusy"))
  {
    *addr = (uintptr_t)&QueryPropagationC$forwardBusy[__nesc_mote];
    *size = sizeof(QueryPropagationC$forwardBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$nodeID"))
  {
    *addr = (uintptr_t)&QueryPropagationC$nodeID[__nesc_mote];
    *size = sizeof(QueryPropagationC$nodeID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$cache"))
  {
    *addr = (uintptr_t)&QueryPropagationC$cache[__nesc_mote];
    *size = sizeof(QueryPropagationC$cache[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$index"))
  {
    *addr = (uintptr_t)&QueryPropagationC$index[__nesc_mote];
    *size = sizeof(QueryPropagationC$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$fwdIndex"))
  {
    *addr = (uintptr_t)&QueryPropagationC$fwdIndex[__nesc_mote];
    *size = sizeof(QueryPropagationC$fwdIndex[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "QueryPropagationC$sensorState"))
  {
    *addr = (uintptr_t)&QueryPropagationC$sensorState[__nesc_mote];
    *size = sizeof(QueryPropagationC$sensorState[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module QueryPropagationC */
  memset((void *)&QueryPropagationC$queryPacket[__nesc_mote], 0, sizeof QueryPropagationC$queryPacket[__nesc_mote]);
  memset((void *)&QueryPropagationC$fwdQueryPacket[__nesc_mote], 0, sizeof QueryPropagationC$fwdQueryPacket[__nesc_mote]);
  memset((void *)&QueryPropagationC$nonePacket[__nesc_mote], 0, sizeof QueryPropagationC$nonePacket[__nesc_mote]);
  memset((void *)&QueryPropagationC$seqNo[__nesc_mote], 0, sizeof QueryPropagationC$seqNo[__nesc_mote]);
  memset((void *)&QueryPropagationC$broadcastBusy[__nesc_mote], 0, sizeof QueryPropagationC$broadcastBusy[__nesc_mote]);
  memset((void *)&QueryPropagationC$forwardBusy[__nesc_mote], 0, sizeof QueryPropagationC$forwardBusy[__nesc_mote]);
  memset((void *)&QueryPropagationC$nodeID[__nesc_mote], 0, sizeof QueryPropagationC$nodeID[__nesc_mote]);
  memset((void *)&QueryPropagationC$cache[__nesc_mote], 0, sizeof QueryPropagationC$cache[__nesc_mote]);
  memset((void *)&QueryPropagationC$index[__nesc_mote], 0, sizeof QueryPropagationC$index[__nesc_mote]);
  memset((void *)&QueryPropagationC$fwdIndex[__nesc_mote], 0, sizeof QueryPropagationC$fwdIndex[__nesc_mote]);
  memset((void *)&QueryPropagationC$sensorState[__nesc_mote], 0, sizeof QueryPropagationC$sensorState[__nesc_mote]);
