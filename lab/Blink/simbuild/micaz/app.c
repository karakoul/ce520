...
static inline void BlinkC$Timer$fired(void )
{
  sim_log_debug(148U, "BlinkC", "Timer fired @ %s.\n", sim_time_string());
  sim_log_debug(149U, "Tolhs", "Timer fired @ %s.\n", sim_time_string());
...
static inline void BlinkC$Timer1$fired(void )
{
  sim_log_debug(150U, "New", "Timer1 fired @ %s. \n", sim_time_string());
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b673a8){
#line 83
  switch (arg_0x40b673a8) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b673a8);
#line 83
      break;
#line 83
    }
...
static inline void BlinkC$Boot$booted(void )
{
  ...
  BlinkC$Timer1$startPeriodic(2000);
}
