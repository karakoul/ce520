...
typedef uint16_t BlinkC$Read$val_t;
...
typedef uint16_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t;
typedef /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t;
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void BlinkC$checkBrightness$runTask(void );
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void BlinkC$Read$readDone(error_t result, BlinkC$Read$val_t val);
...
static error_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t BlinkC$checkBrightness$postTask(void );
# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static error_t BlinkC$Read$read(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
...
#line 61
  BlinkC$checkBrightness = 3U
};
#line 61
typedef int BlinkC$__nesc_sillytask_checkBrightness[BlinkC$checkBrightness];
#line 59
uint16_t BlinkC$res[1000];

static inline void BlinkC$checkBrightness$runTask(void );
...
static inline void BlinkC$Read$readDone(error_t result, uint16_t data);
# 42 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void );
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
enum /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_unnamed4337 {
#line 47
  ConstantSensorC$0$senseResult = 6U
};
#line 47
typedef int /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_sillytask_senseResult[/*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult];
#line 47
static inline void /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );



static inline error_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read(void );
...
#line 61
{
  if (BlinkC$res[sim_node()] > 40) {
      BlinkC$Leds$led0Toggle();
      sim_log_debug(148U, "Sensor_result", "Check %d.\n", BlinkC$res[sim_node()]);
    }
}
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t BlinkC$checkBrightness$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(BlinkC$checkBrightness);
#line 67
...
#line 80
{
  sim_log_debug(150U, "Sensor_result", "Result %d.\n", data);
  BlinkC$res[sim_node()] = data;
  BlinkC$checkBrightness$postTask();
}

# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val){
#line 63
  BlinkC$Read$readDone(result, val);
#line 63
}
#line 63
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
...
#line 47
{
  /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(SUCCESS, 48879U);
}
...
#line 75
      break;
#line 75
    case BlinkC$checkBrightness:
#line 75
      BlinkC$checkBrightness$runTask();
#line 75
      break;
#line 75
...
#line 75
      break;
#line 75
    case /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult:
#line 75
      /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask();
#line 75
      break;
#line 75
    default:
...
#line 53
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(/*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult);
#line 67
...
#line 51
{
  return /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$postTask();
}

# 55 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static error_t BlinkC$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*BlinkAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$read();
#line 55
...
static inline void BlinkC$Timer$fired(void )
{
  sim_log_debug(149U, "BlinkC", "Timer fired @ %s.\n", sim_time_string());
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b663a8){
#line 83
  switch (arg_0x40b663a8) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b663a8);
#line 83
      break;
#line 83
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module BlinkC */
  if (!strcmp(varname, "BlinkC$res"))
  {
    *addr = (uintptr_t)&BlinkC$res[__nesc_mote];
    *size = sizeof(BlinkC$res[__nesc_mote]);
    return 0;
  }
